...
class AppConstants {
  ...
  static const String APP_NAME = 'Çamlıbel Su ';

  static const String BASE_URL = 'https://camlibelnuralsu.com';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.united_kindom, languageName: 'Türkçe', countryCode: 'TR', languageCode: 'tr'),
