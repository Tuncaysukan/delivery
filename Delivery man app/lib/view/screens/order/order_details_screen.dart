                              ...
                              Row(children: [
                                ClipRRect(
                                  ...
                                  child: FadeInImage.assetNetwork(
                                    placeholder: Images.placeholder,
                                    image:
                                        '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${order.orderDetails[index].productDetails.image[0]}',
                                    height: 70,
                                    width: 80,
                                    fit: BoxFit.cover,
                                  ),
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Row(children: [
                                      ...
                                      Text(
                                        ...
                                        style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).highlightColor),
                                      ),
                                    ]),
                                  ]),
                                ),
